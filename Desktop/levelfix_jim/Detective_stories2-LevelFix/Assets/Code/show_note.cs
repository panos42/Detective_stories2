...
public class Note : MonoBehaviour
{
    ...
    void Update()
    {
        if (noteUIPanel.activeSelf && Input.GetMouseButtonDown(0) || (Input.GetKeyDown(KeyCode.Escape) && noteUIPanel.activeSelf)) // Check if the note UI is active and the player clicks
        {
